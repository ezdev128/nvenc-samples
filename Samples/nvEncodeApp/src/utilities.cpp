...
void printHelp()
{
    printf("[ NVENC 4.0 Command Line Encoder]\n");
    ...
    printf("   [rcMode]                   Rate Control Mode (0=Constant QP, 1=VBR, 2=CBR, 4=VBR_MinQP, 8=Multi pass encoding optimized for image quality, 16= Multi pass encoding optimized for maintaining frame size, 32=Multi pass VBR\n");
    ...
    printf("                              128 = (High Profile Stereo)\n");
    printf("                              244 = (High Profile 444)\n");
    printf("                              257 = (Constrained High Profile)\n");
    ...
    printf("                              8 = NV_ENC_PRESET_LOSSLESS_DEFAULT\n");
    printf("                              9 = NV_ENC_PRESET_LOSSLESS_HP\n");
    ...
    printf("   [chromaformatIDC]          Specifies the chroma format. Should be set to 1 for yuv420 input, 3 for yuv444 input\n");
    printf("   [sliceMode]                This parameter in conjunction with sliceModeData specifies the way in which the picture is divided into slices.\n");
    printf("                              sliceMode = 0 MB based slices, sliceMode = 1 Byte based slices, sliceMode = 2 MB row based slices, sliceMode = 3, numSlices in Picture.\n");
    printf("   [sliceModeData]            Specifies the parameter needed for sliceMode. For: \n");
    printf("                              sliceMode = 0, sliceModeData specifies # of MBs in each slice (except last slice)\n");
    printf("                              sliceMode = 1, sliceModeData specifies maximum # of bytes in each slice (except last slice)\n");
    printf("                              sliceMode = 2, sliceModeData specifies # of MB rows in each slice (except last slice)\n");
    printf("                              sliceMode = 3, sliceModeData specifies number of slices in the picture. Driver will divide picture into slices optimally\n");
    printf("   [separateColourPlaneFlag]  Set to 1 to enable 4:4:4 separate colour planes \n");
    printf("   [cabacenable]              when set enables CABAC entropy coding mode.\n");
    printf("   [mvprecision]              Specifies the desired motion vector prediction precision.\n");
